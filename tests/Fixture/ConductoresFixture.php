...
class ConductoresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'id_vehiculo' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'vehiculo' => ['type' => 'index', 'columns' => ['id_vehiculo'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'vehiculo' => ['type' => 'foreign', 'columns' => ['id_vehiculo'], 'references' => ['vehiculos', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
